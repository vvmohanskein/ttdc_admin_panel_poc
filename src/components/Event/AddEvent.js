...
const navigate= useNavigate()
  ...
  const handleSubmit = async (values) => {
    ...
    axios.put(`https://demo.emeetify.com:81/tourism/places/eventupdate/${numberId}`,formData,   {
      headers: {
                        ...
                        >
                          <CardContent>
                            <Typography
                              variant="h6"
                              gutterBottom
                              sx={{ fontFamily: 'Montserrat', fontWeight: 'bold', color: '#3f51b5', fontSize: '1.2rem' }}
                            >
                              Preview image:
                            </Typography>
                            <Divider sx={{ mb: 1 }} />
                            <CardMedia
                              ...
                              component="img"
                              src={values.image instanceof File ? URL.createObjectURL(values.image) : locationData?.image_url}
                              alt="Selected"
                              sx={{
                                maxHeight: '200px',
                                borderRadius: '10px',
                            ...
                            <Typography variant="body2" mt={1} sx={{ fontFamily: 'Montserrat', fontWeight: 'medium', color: '#555', fontSize: '0.875rem' }}>
                              Selected File: <strong>{values.image instanceof File ? values.image.name : 'No file selected'}</strong>
                            </Typography>
                          </CardContent>
                        </Card>
                      )}
