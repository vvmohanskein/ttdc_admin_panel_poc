...
function Event() {
  ...
  const handleEdit = (index, card) => {
    ...
    axios
      .get(
        `https://demo.emeetify.com:81/tourism/places/getplaces?PlaceId=${numberId}&source=socketio&lang=en`
      )
      .then((response) => {
  ...
  const handleDeleteEvent = () => {
    if (deleteId) {
      axios
        .delete(
          `https://demo.emeetify.com:81/tourism/places/eventdelete/${deleteId}`
        )
        .then((response) => {
              ...
              <Grid item xs={12} sm={6} md={4} key={index}>
                ...
                >
                  <CardActionArea sx={{ flexGrow: 1 }}>
                    ...
                    <Box sx={{ height: "10rem", overflow: "hidden" }}>
                      <CardMedia
                        component="img"
                        alt={card.title}
                        height="100%"
                  ...
                  <CardContent
                    sx={{
                      ...
                      height: "100px" // Fixed height to keep it uniform
                    }}
                  >
                    <Typography
                      gutterBottom
